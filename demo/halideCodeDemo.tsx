  ...
  return (
    <>
      <style>{`
        ...
        .LinkBtn:hover { background: var(--accent); transform: translateY(-5px); }
      ...
      <div className="halide-body">
        ...
        <div className="interface-grid">
          <div style={{ fontWeight: 700 }}>D_E_M_O</div>
          ...
          <h1 className="hero-title">ARIYAN's<br />demo app</h1>

          <div style={{ gridColumn: '1 / -1', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            <div style={{ fontFamily: 'monospace', fontSize: '0.75rem' }}>
              <p>[ Made for a desktop ]</p>
              <p>DELIVERING CONTENT ON COMMAND</p>
            </div>
            <div className='flex space-x-3'>
              <Link href={"/demoOne"} className="LinkBtn">Visit another component</Link>
              <Link href={"/demoTwo"} className="LinkBtn">Contact Me</Link>
            </div>
          </div>
        </div>
